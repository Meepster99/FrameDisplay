...
static const char *get_th075_move_name(int character, int id) {
	...
	case 9: return "air"; break;
	case 10: return "land"; break;
	case 40: return "name"; break;
	case 41: return "portrait"; break;
	case 42: return "spellcard 1"; break;
	case 43: return "spellcard 2"; break;
	case 44: return "spellcard 3"; break;
	case 45: return "spellcard 4"; break;
	case 46: return "spellcard 5"; break;
	case 47: return "spellcard 6"; break;
	case 50: return "5 hitstun light"; break;
	case 51: return "5 hitstun medium"; break;
	case 52: return "5 hitstun heavy"; break;
	case 53: return "5 hitstun reel"; break;
	case 62: return "2 hitstun light"; break;
	case 63: return "2 hitstun medium"; break;
	case 64: return "2 hitstun heavy"; break;
	case 65: return "2 hitstun reel"; break;
	case 93: return "wakeup roll"; break;
	case 94: return "wakeup roll"; break;
	case 95: return "wakeup 8"; break;
	case 150: return "5 blockstun light"; break;
	case 151: return "5 blockstun medium"; break;
	case 152: return "5 blockstun heavy"; break;
	case 154: return "2 blockstun light"; break;
	case 155: return "2 blockstun medium"; break;
	case 156: return "2 blockstun heavy"; break;
	case 158: return "j.blockstun"; break;
	case 200: return "6D"; break;
	case 201: return "4D"; break;
	case 202: return "j.6D"; break;
	case 203: return "j.4D"; break;
	case 204: return "8D"; break;
	case 205: return "9D"; break;
	case 206: return "7D"; break;
	case 207: return "land"; break;
	case 309: return "22B"; break;
	case 310: return "22A"; break;
	case 390: return "6DA"; break;
	case 391: return "6DB"; break;
	case 392: return "3DA"; break;
	case 393: return "3DB"; break;
	}
	...
	case 10: // Meiling
		switch(id) {
		case 300: return "5A"; break;
		case 301: return "5B"; break;
			// 302???
		case 303: return "2A"; break;
		case 304: return "2B"; break;
		case 305: return "j.5A"; break;
		case 306: return "j.5B"; break;
		case 307: return "6B"; break;
		case 308: return "6A"; break;
		case 320: return "5AA"; break;
		case 321: return "5AB"; break;
		case 322: return "5AAA"; break;
		case 323: return "5AAB"; break;
		case 324: return "5AAAA"; break;
		case 325: return "5AAAB"; break;
		case 326: return "5AAA2B"; break;
		}
		break;
	case 1: // Marisa
	case 2: // Sakuya
	...
	case 7: // Yuyuko
		...
		case 300: return "5A"; break;
		case 301: return "5B"; break;
		case 302: return "2A"; break;
		case 303: return "2B"; break;
		case 304: return "j.5A"; break;
		case 305: return "j.5B"; break;
		case 307: return "6A"; break;
		case 308: return "6B"; break;
		}
		break;
	case 5: // Youmu
	case 9: // Suika
	...
	case 8: // Yukari
		...
		case 307: return "6A"; break;
		case 308: return "6B"; break;
		case 320: return "j.2A"; break;
		case 321: return "j.2B"; break;
		}
	}
...
int Touhou_FrameDisplay::get_subframe() {
	return m_subframe_base + m_subframe;
}
...
void Touhou_FrameDisplay::render_frame_properties(bool detailed, int scr_width, int scr_height) {
	...
	sprintf(strbuf,
		"duration %d\n\n fflags %8.8x\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n",
		frame->header.duration, frame->props.fflags,
		(frame->props.fflags & 1) ? "Standing" : "-",
	...
	if (frame->n_boxes_attack > 0) {
		sprintf(strbuf + strlen(strbuf),
			" aflags %8.8x\n block: %s %s %s %s\n%s\n%s\n%s\n%s\n\n",
			frame->props.aflags,
			(frame->props.aflags & 2) ? "H" : "-",
			(frame->props.aflags & 4) ? "L" : "-",
			(frame->props.aflags & 8) ? "A" : "-",
			(frame->props.aflags & 16) ? "U" : "-",
			(frame->props.aflags & 1024) ? "Induces CH" : "-",
			(frame->props.
			 aflags & 262144) ? "Ungrazeable" : "-",
			(frame->props.
			 aflags & 524288) ? "Guard crush" : "-",
			(frame->props.aflags & 2097152) ? "Stagger" : "-");
		if (m_game_id == TOUHOU_GAME_TH075 || m_game_id == TOUHOU_GAME_TH075_11) {
			sprintf(strbuf + strlen(strbuf),
				"   Damage: %d\nSpiritDmg: %d, %d\n     Chip: %d, %d\nProration: %d\n   Untech: %d\nMeterGain: %d %d\nVelocityX: %d\nVelocityY: %d\n     Type: %d %d %d\n",
				frame->props.damage, (frame->props.damage) / 2,
				(frame->props.damage) / 4,
				frame->props.chip + (frame->props.damage / 10),
				frame->props.chip, frame->props.proration,
				frame->props.untech, frame->props.unk9,
				frame->props.unk10, frame->props.velocity_x,
				frame->props.velocity_y, frame->props.unk15,
				frame->props.unk16, frame->props.attack_type);
		} else {
			sprintf(strbuf + strlen(strbuf),
				"   Damage: %d\nProration: %d\n    Limit: %d\n   Untech: %d\nCard Gain: %d %d\nVelocityX: %d\nVelocityY: %d\n     Type: %d %d %d\n",
				frame->props.damage, frame->props.proration,
				frame->props.limit, frame->props.untech,
				frame->props.unk9, frame->props.unk10,
				frame->props.velocity_x, frame->props.velocity_y,
				frame->props.unk15, frame->props.unk16,
...
const char *Touhou_FrameDisplay::get_sprite_filename(int n) {
	static char buf[256];
	if (m_game_id == TOUHOU_GAME_TH075 || m_game_id == TOUHOU_GAME_TH075_11) {
		sprintf(buf, "data_character_%2.2d-%3.3d.png",
			m_character, n);
	} else {
