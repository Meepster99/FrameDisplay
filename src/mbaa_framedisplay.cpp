...
static const int mbaa_ncharacter_info = sizeof(mbaa_character_info)/sizeof(mbaa_character_info[0]);
...
int MBAA_FrameDisplay::get_subframe() {
...
void MBAA_FrameDisplay::set_active_character(int n) {
	...
	if (m_character_data.load(&m_iso, mbaa_character_info[n].file_name, mbaa_character_info[n].moon)) {
		if (need_gfx) {
